...
#include "DHT.h"
#define DHTPIN PB3     // what digital pin we're connected to
// Uncomment whatever type you're using!
#define DHTTYPE DHT11   // DHT 11
//#define DHTTYPE DHT22   // DHT 22  (AM2302), AM2321
//#define DHTTYPE DHT21   // DHT 21 (AM2301)
DHT dht(DHTPIN, DHTTYPE);
#define CS   PB4  //Pin 2 as chip selection output
#define WR   PB2  //Pin 3 as read clock output
#define DATA PB1  //Pin 4 as Serial data output
...
void setup() {
 ...
 // if (! rtc.isrunning()) {
   // Serial.println("RTC is NOT running!");
    ...
    // rtc.adjust(DateTime(2018, 10, 20, 12, 19, 0));
 // }
  delay(1000);
}
...
//  delay(1000);
   ...
   Write_1621(8,num[zh]);
  Write_1621(6,num[uh]); 
  Write_1621(4,num[sh]+num[29]);  // number with decimal points
  Write_1621(2,num[23]);  // r
  Write_1621(0,num[17]);  // H
  delay(3000);
//} 
